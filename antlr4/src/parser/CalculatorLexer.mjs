...
1,0,0,0,9,25,1,0,0,0,11,27,1,0,0,0,13,30,1,0,0,0,15,35,1,0,0,0,17,18,5,43,
0,0,18,2,1,0,0,0,19,20,5,45,0,0,20,4,1,0,0,0,21,22,5,42,0,0,22,6,1,0,0,0,
23,24,5,47,0,0,24,8,1,0,0,0,25,26,5,40,0,0,26,10,1,0,0,0,27,28,5,41,0,0,
...
export default class CalculatorLexer extends antlr4.Lexer {
	...
	static symbolicNames = [ null, null, null, null, null, null, null, "NUMBER", 
                          "WS" ];
	static ruleNames = [ "T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "NUMBER", 
                      "WS" ];
